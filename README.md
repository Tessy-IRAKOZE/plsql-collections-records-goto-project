...
A library wants to track which books a member has borrowed.

Each member has:

* A Member ID
* A Member Name
* A list of up to 5 borrowed books

The system should:

* Store the book titles in a VARRAY collection
* Store member information in a Record
* Count how many books were borrowed
* Use a GOTO statement to handle cases where no books were borrowed
* Display the member’s details and borrowed books
